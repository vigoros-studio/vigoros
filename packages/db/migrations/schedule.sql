...
select cron.schedule('vigoros-reference-first', '50 0 * * *', $$select public.call_vigoros_job('reference')$$);
select cron.schedule('vigoros-reference',     '*/10 1-5 * * *', $$select public.call_vigoros_job('reference')$$);
